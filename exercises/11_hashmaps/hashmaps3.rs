...
fn build_scores_table(results: String) -> HashMap<String, Team> {
    ...
    for r in results.lines() {
        ...
        if scores.contains_key(&team_1_name) {//verifica se ja existe o time na tabela
            scores.get_mut(&team_1_name).unwrap().goals_scored += team_1_score; //se existir, pega o time e soma os gols
